...
#include "usart.h"
#include "sys.h"
#define FLASH_SAVE_ADDR  0X08017000 	//设置FLASH 保存地址(必须为偶数，且其值要大于本代码所占用FLASH的大小+0X08000000)
uint8_t Update_Flag=0;
extern uint32_t Local_ID;
u16 ID_Parameter[10],Flash_Parameter[10];  //Flash相关数组
//////////////////////////////////////////////////////////////////////////////////	 
...
{
	STMFLASH_Read(FLASH_SAVE_ADDR,(u16*)ID_Parameter,10);
	Update_Flag = ID_Parameter[1];
